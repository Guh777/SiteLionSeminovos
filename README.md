...
2. Escolha o local para salvar o projeto
2.1 Navegue até a pasta onde deseja baixar o repositório usando o comando cd.
Exemplo:
cd C:\Users\SeuUsuario\Projetos

3. Clone o repositório
Use o comando git clone seguido do link do repositório para baixar os arquivos do projeto:

git clone https://github.com/Guh777/SiteLionSeminovos/

4.Acesse o diretório do projeto
Após o repositório ser clonado, entre na pasta do projeto:
cd SiteLionSeminovos
